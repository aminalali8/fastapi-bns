...
# WARNING: Ensure imports from `fastapi_bns` comes after this line
from fastapi_bns import app, settings, db  # noqa
from fastapi_bns.cli import create_user, cli  # noqa
